...
RESOURCE_PATH = "http://localhost:8080/data"
HOST = "0.0.0.0"
PORT = 9105
RECEIVER_REFRESH_INTERVAL = 10
AIRCRAFT_REFRESH_INTERVAL = 10
STATISTICS_REFRESH_INTERVAL = 60
...
def main():
    ...
    mon = Dump1090Exporter(
        ...
        host=HOST,
        port=PORT,
        aircraft_interval=AIRCRAFT_REFRESH_INTERVAL,
        stats_interval=STATISTICS_REFRESH_INTERVAL,
        receiver_interval=RECEIVER_REFRESH_INTERVAL,
        origin=(ricevitore.lat, ricevitore.lon)
    )
